...
public class PanelTablaClientesCotizacion extends JPanel {
    ...
    public PanelTablaClientesCotizacion() throws Exception {
        ...
        seleccionarCliente.addActionListener(e -> {
            ...
            if (filaSeleccionada != -1) {
                ...
                CotizacionPanel.txtCliente.setText(datoId + " - " + datoNombre + " - " + datoCUIT);
                CotizacionPanel.clienteID = Integer.parseInt(datoId);
                JFrame frame = (JFrame) SwingUtilities.getWindowAncestor(PanelTablaClientesCotizacion.this);
                frame.dispose();
            } else {
