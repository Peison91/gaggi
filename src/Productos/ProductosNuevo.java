...
class ProductosNuevo extends JPanel {
    JTextField txtDescr;
    JTextField txtCodProd;
    JTextField txtAbrevProd;
    JTextField txtPreciounitProd;
    ...
    public ProductosNuevo() throws Exception {
        ...
        btnGuardar.addActionListener(e -> {
            ...
            Productos productosNuevo = new Productos(0, descr, cod, abrev, precioUnit, stockmin, stock);
            try {
        ...
        add(stockProd);
        add(txtStock);
        tablaProductos.setBounds(20,170,850, 350);
        add(tablaProductos);
    }
